 ...
 *
 * Uso:
 *   node .agents/scripts/release.mjs          → bump de PATCH  (0.1.0 → 0.1.1)
 *   node .agents/scripts/release.mjs minor    → bump de MINOR  (0.1.0 → 0.2.0)
 *   node .agents/scripts/release.mjs major    → bump de MAJOR  (0.1.0 → 1.0.0)
 */
