...
|--------|------|-------------|-----------|
| 0.1.0 | 2026-03-15 | arquitetura | Baseline Inicial — scaffold gerado via `forge-module` a partir de US-MOD-000 (READY). Stubs obrigatórios criados: DATA-003, SEC-EventMatrix. Todos os itens nascem em `estado_item: DRAFT`. |
