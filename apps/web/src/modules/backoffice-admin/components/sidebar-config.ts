...
const SIDEBAR_GROUPS: SidebarGroup[] = [
    ...
    items: [
      {
        ...
        activeMatch: '/processos/ciclos',
      },
      {
        id: 'nav-process-roles',
        label: 'Papéis de Processo',
        icon: 'workflow',
        route: '/processos/papeis',
        requiredScope: 'process:cycle:read',
        activeMatch: '/processos/papeis',
      },
      {
        id: 'nav-cases',
        label: 'Casos',
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'nav-framer-types',
        label: 'Tipos de Enquadrador',
        icon: 'sliders',
        route: '/parametros/tipos-framer',
        requiredScope: 'param:framer:read',
        activeMatch: '/parametros/tipos-framer',
      },
      {
        id: 'nav-target-objects',
        label: 'Target Objects',
        icon: 'sliders',
        route: '/parametros/target-objects',
        requiredScope: 'param:framer:read',
        activeMatch: '/parametros/target-objects',
      },
      {
        id: 'nav-incidence-rules',
        label: 'Regras de Incidência',
        icon: 'sliders',
        route: '/parametros/incidencia',
        requiredScope: 'param:framer:read',
        activeMatch: '/parametros/incidencia',
      },
      {
        id: 'nav-routines',
        label: 'Rotinas',
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'nav-integration-services',
        label: 'Serviços',
        icon: 'plug',
        route: '/integration/services',
        requiredScope: 'integration:service:read',
        activeMatch: '/integration/services',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: 'bot',
        route: '/mcp/actions',
        requiredScope: 'mcp:action:read',
        activeMatch: '/mcp/actions',
      },
      {
        id: 'nav-mcp-action-types',
        label: 'Tipos de Ação',
        icon: 'bot',
        route: '/mcp/action-types',
        requiredScope: 'mcp:action:read',
        activeMatch: '/mcp/action-types',
      },
      {
