  ...
  return (
    ...
    >
      <div className="w-[420px] rounded-xl bg-white p-6 shadow-[0_8px_32px_rgba(0,0,0,0.12)]">
        ...
        <h3 className="mt-4 text-center text-lg font-bold text-[#111]">Desativar departamento?</h3>
        <p className="mt-2 text-center text-[13px] text-[#555]">
          Deseja desativar o departamento <strong className="text-[#111]">{nome}</strong>? Ele
