...
| 422 | Inline validation no drawer | `extensions.invalid_fields[]` + mensagens de regra (auto-auth, escopos proibidos) |
| 5xx | Toast Error genérico | "Erro inesperado. Tente novamente." |
...
- **rastreia_para:** US-MOD-004, US-MOD-004-F03, US-MOD-004-F04, FR-001, BR-001, SEC-001, DATA-003, DOC-UX-010, DOC-ARC-003
- **referencias_exemplos:** EX-API-001 (endpoints), EX-OBS-001 (telemetria)
- **evidencias:** N/A
