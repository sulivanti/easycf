...
| 0.1.0 | 2026-03-16 | arquitetura | Baseline Inicial — scaffold gerado via `forge-module` a partir de US-MOD-004 (READY). Stubs obrigatórios criados: BR-001, FR-001, DATA-001, DATA-003, INT-001, SEC-001, SEC-EventMatrix, UX-001, NFR-001. Todos os itens nascem em `estado_item: DRAFT`. |
