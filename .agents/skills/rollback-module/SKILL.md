...
## Passo Intermediário: Atualização do Índice Global (update-markdown-file-index)

> [!IMPORTANT]
> Este passo é obrigatório. Sem ele, o `docs/INDEX.md` manterá referências quebradas para uma pasta que não existe mais — comportamento idêntico ao da skill `delete-module`.

Após a exclusão da pasta do módulo, **invoque a skill `update-markdown-file-index`**:
