/**
 * @contract DOC-GNP-00, BR-001, FR-013
 *
 * Fastify error handler that maps DomainError hierarchy to
 * RFC 9457 Problem Details responses.
 * Propagates X-Correlation-ID in error responses.
 */

import type { FastifyError, FastifyReply, FastifyRequest } from 'fastify';
import { DomainError } from '../domain/errors/domain-errors.js';
import { RateLimitExceededError } from '../domain/errors/domain-errors.js';
import type { ProblemDetails } from './dtos/common.dto.js';

export function foundationErrorHandler(
