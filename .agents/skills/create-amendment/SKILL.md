...
**Regra Inviolável:** Consulte sempre o `docs/01_normativos/DOC-DEV-001_especificacao_executavel.md` e o `DOC-ARC-003__Ponte_de_Rastreabilidade.md` para garantir que o formato do seu texto respeita as diretrizes vigentes. Não deduza tabelas soltas.
