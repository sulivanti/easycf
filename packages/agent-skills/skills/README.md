...
| `forge-module` | Fórja a estrutura completa de um novo módulo (MOD-XXX) lendo as regras do DOC-DEV-001 (Paradigma XP). | **Triggers:** "forge module", "scaffold module"<br>**Exemplos:** *"Scaffold do novo módulo MOD-020 de Contabilidade"*, *"Gerar estrutura do MOD-015"* |
