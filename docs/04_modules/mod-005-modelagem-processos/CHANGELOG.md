...
|--------|------|-------------|-----------|
| 1.9.0 | 2026-04-01 | validate-all | Validação Fase 3 pós-codegen v2 aprovada. Lint: PASS (0 erros). Arquitetura: PASS (4/4 DomainError, Pattern A, 6 hooks react-query). Promotion: PASS (4/4 READY). Manifests: 2/2 PASS. Drizzle: PASS (7 tabelas, 18 indexes). Endpoints: 27/27 PASS. 0 bloqueadores, 0 violações, 2 avisos. |
| 1.8.0 | 2026-04-01 | codegen | Codegen v2 (AGN-COD-WEB): 4 arquivos atualizados conforme spec 70. FlowEditorPage (TopToolbar h:56, StatusBadge 3 variantes, Swimlanes alternadas, MiniMap 120x80, ZoomControls, EmptyCanvasState 400x200, ReadonlyBanner h:44), StageConfigPanel (480px, GateTypeBadge 4 cores, AutoSaveIndicator, TabBar spec, DragHandle), StageNode (180x72, r:12, badges 9px), types (GATE_TYPE_META cores) |
| 1.7.0 | 2026-04-01 | merge-amendment | Merge UX-005-M03: UX-005 bumped para v0.6.0 — layouts pixel-perfect spec 70 (TopToolbar, StageNode 180x72, Swimlanes alternadas, GateDiamond, MiniMap/ZoomControls, StageConfigPanel 480px, GateTypeBadge 4 variantes, 21 cores, responsividade) |
| 1.6.0 | 2026-04-01 | create-amendment | Amendment UX-005-M03: alinhar UX com spec 70-process-editor — TopToolbar (h:56, StatusBadge 3 variantes), StageNode (180x72, r:12, badges), Swimlanes (cores alternadas #F0F7FF/#FFF8F0), GateDiamond (24x24), MiniMap/ZoomControls, GateTypeBadge 4 variantes (APPROVAL/DOCUMENT/CHECKLIST/INFORMATIVE), AutoSaveIndicator 3 estados, 21 cores, responsividade 4 breakpoints |
